...
ActiveRecord::Schema[8.0].define(version: 20_260_416_181_710) do
  ...
  create_table 'employees', force: :cascade do |t|
    ...
    t.index %w[country job_title salary], name: 'index_employees_on_country_and_job_title_and_salary'
    t.index %w[country job_title], name: 'index_employees_on_country_and_job_title'
